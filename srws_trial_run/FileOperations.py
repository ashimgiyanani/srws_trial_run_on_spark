...
#         searchStr = '(\d{4}-\d{2}-\d{2}_\d{2}-\d{2}-\d{2})'
    ...
    def FnUnzipFile(filepath, **kwargs):
        ...
        path_7zip =  r"C:\Program F7z.exeiles\7-Zip\7z.exe" 
    ...
    def remove_duplicates_and_save(src_path, dest_path, regStr):
        ...
        for file in files:
            # Check if the file is a CSV file (you can modify for other file types)
            if file.endswith(".txt"):
                # Read the CSV file into a DataFrame
                df = pd.read_csv(os.path.join(src_path, file), header=1)
    ...
    # Example usage
    # input_folder = r"c:\Users\giyash\OneDrive - Fraunhofer\Python\Scripts\HighRe\data\Bowtie1"
    # output_file = r"c:\Users\giyash\OneDrive - Fraunhofer\Python\Scripts\HighRe\data\Bowtie1\finished_files2.txt"
    # regStr = 'finished*.txt'
    # remove_duplicates_and_save(input_folder, output_file, regStr)
...
if __name__ == "__main__":
    ...
    src_path = r"c:\Users\giyash\OneDrive - Fraunhofer\Python\Scripts\HighRe\data\Bowtie1"
    dest_path = r"c:\Users\giyash\OneDrive - Fraunhofer\Python\Scripts\HighRe\data\Bowtie1\finished_files.txt"
    regStr = 'finished*.txt'
